import { isNetlifySiteOrDeploy, resolveAppMode, resolveProductName } from "./environmentRouting";
...
export const IS_PRIVATE_HOST = isNetlifySiteOrDeploy(hostname, "arriendos-23");
export const IS_DEMO_HOST = isNetlifySiteOrDeploy(
  hostname,
